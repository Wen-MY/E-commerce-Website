...
<body>
	...
	<div class="pic_container">
		...
		<h3><span class="firstLine">PURE CHOCOLATE<br><br><br><span class="secLine">WE ARE "PURELY" ADDICTED</h3>
		<h3><span class="firstLine">NAMA<br><br><br><span class="secLine">LUXURIOUSLY SOFT AND CREAMY</h3>
	</div>
